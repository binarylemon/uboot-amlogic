...
//*****************************************
#define MODEL_NAME           "B140RTN03" /** lcd model name */
...
#define H_ACTIVE             1600 /** horizontal resolution */
#define V_ACTIVE             900  /** vertical resolution */
#define H_PERIOD             2032 /** horizontal period(htotal) */
#define V_PERIOD             930  /** vertical period(vtotal) */

#define LCD_CLK              113385600//76224960 /** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL              1 /** clk_polarity(only valid for TTL) */
#define HS_WIDTH             32 /** hsync_width */
#define HS_BACK_PORCH        168 /** hsync_backporch(without hsync_width) */
#define HS_POL               1 /** hsync_polarity(0=negative, 1=positive) */
#define VS_WIDTH             7 /** vsync_width */
#define VS_BACK_PORCH        11 /** vsync_backporch(without vsync_width) */
