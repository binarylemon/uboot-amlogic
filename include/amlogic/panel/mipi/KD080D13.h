...
//*****************************************
#define MODEL_NAME           "KD080D13" /** lcd model name */
...
#define ACITVE_AREA_HEIGHT   172 /** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define H_PERIOD             880  /** horizontal period(htotal) */
#define V_PERIOD             1380 /** vertical period(vtotal)*/

#define LCD_CLK              72864000 /** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL              0  /** clk_polarity(only valid for TTL) */
#define HS_WIDTH             16 /** hsync_width */
#define HS_BACK_PORCH        48 /** hsync_backporch(without hsync_width) */
#define HS_POL               0  /** hsync_polarity(0=negative, 1=positive) */
#define VS_WIDTH             4  /** vsync_width */
#define VS_BACK_PORCH        4  /** vsync_backporch(without vsync_width) */
