...
int aml1218_set_charge_end_rate(int rate)
{
    ...
    return aml1218_set_bits(0x002d, val, 0x08);
}
...
int aml1218_init(void)
{
    ...
    aml1218_write(0x009E, 0x08);//enable VBAT measure result average 4 samples
    aml1218_write(0x009F, 0x20);//enable IBAT measure result average 4 samples
    aml1218_write(0x009A, 0x20);
    aml1218_write(0x00B8, 0x00);
    aml1218_write(0x00A9, 0x8f);

    aml1218_write(0x00A0, 0x01);//select auto-sampling timebase is 2ms
