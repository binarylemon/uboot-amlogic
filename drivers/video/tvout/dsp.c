...
//TODO    	CLEAR_MPEG_REG_MASK(AUD_ARC_CTL, (0xfff << 4));
 //   SET_MPEG_REG_MASK(SDRAM_CTL0,1);//arc mapping to ddr memory
//TODO    	SET_MPEG_REG_MASK(AUD_ARC_CTL, ((AUDIO_DSP_START_PHY_ADDR)>> 20) << 4);

	
//TODO	SET_MPEG_REG_MASK(AUD_ARC_CTL, 1);
//TODO	CLEAR_MPEG_REG_MASK(AUD_ARC_CTL, 1);
