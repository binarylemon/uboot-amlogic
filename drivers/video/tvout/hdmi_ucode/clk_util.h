...
extern void clocks_set_arm_1_2g(void);
...
extern void clk_util_set_audio_amclk(unsigned long clk_in_mhz);
extern void clk_util_set_audio_amclk_iec958(unsigned long clk_in_mhz);
...
extern void vclk_set_encp_4096x2160( int pll_sel, int pll_div_sel, int vclk_sel, int upsample);
...
extern void vclk_set_enc_640x480( int pll_sel, int pll_div_sel, int vclk_sel, int enc_sel, int upsample);
extern void vclk_set_enc_2560x1600( int pll_sel, int pll_div_sel, int vclk_sel, int enc_sel, int upsample);
