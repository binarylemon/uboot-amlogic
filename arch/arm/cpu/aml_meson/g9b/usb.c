...
{	
	...
	if(port == USB_PHY_PORT_A){
		port_idx = 0;
		peri = (usb_peri_reg_t*)PREI_USB_PHY_REG_A;
	}else if(port == USB_PHY_PORT_B){
		port_idx = 1;
		peri = (usb_peri_reg_t*)PREI_USB_PHY_REG_B;
	}else if(port == USB_PHY_PORT_C){
		port_idx = 2;
		peri = (usb_peri_reg_t*)PREI_USB_PHY_REG_C;
	}else if(port == USB_PHY_PORT_D){
		port_idx = 3;
		peri = (usb_peri_reg_t*)PREI_USB_PHY_REG_D;
	}else{
...
void set_usb_phy_power(amlogic_usb_config_t * usb_cfg,int is_on)
{
	...
	peri_a = (usb_peri_reg_t*)PREI_USB_PHY_REG_A;
	peri_b = (usb_peri_reg_t*)PREI_USB_PHY_REG_B;
	peri_c = (usb_peri_reg_t*)PREI_USB_PHY_REG_C;
	peri_d = (usb_peri_reg_t*)PREI_USB_PHY_REG_D;
