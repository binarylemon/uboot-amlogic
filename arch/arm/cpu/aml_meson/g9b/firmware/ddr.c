...
void set_ddr_clock(struct ddr_set * timing_reg)
{
	...
	do {
		...
		writel(CFG_DDR_PLL_CNTL_1,AM_DDR_PLL_CNTL1);
		writel(CFG_DDR_PLL_CNTL_2,AM_DDR_PLL_CNTL2);
		writel(CFG_DDR_PLL_CNTL_3,AM_DDR_PLL_CNTL3);
		writel(CFG_DDR_PLL_CNTL_4,AM_DDR_PLL_CNTL4);
	...
	//Still need keep MMC in reset mode for power saving? YES(confirmed 1.5mA on m8m2).xb update.
