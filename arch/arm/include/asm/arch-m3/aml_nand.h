...
#define NFC_SET_TIMING_SYNC_ADJUST(delay)                     WRITE_CBUS_REG_BITS(NAND_CFG,delay,16,1) 
...
#define NAND_SYNC_OPTIONS_MASK	0xc0000000
...
#define NAND_ECC_BCH24_MODE NAND_ECC_BCH24_1K_MODE			
#define NAND_ECC_BCH30_MODE NAND_ECC_BCH30_1K_MODE			
#define NAND_ECC_BCH40_MODE NAND_ECC_BCH40_1K_MODE			
#define NAND_ECC_BCH60_MODE NAND_ECC_BCH60_1K_MODE			
...
#define NAND_ONFISYNC_MODE                     0x40000000
#define NAND_TOGGLE_MODE                         0x80000000
...
static void inline  nand_get_chip(void )
{
	...
	SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_2, ((0x1f<<17) | (0x7 << 25)));
}
static void inline nand_release_chip(void)
{
	NFC_SEND_CMD_STANDBY(3);
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_5, 0x7<<7);
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_2, ((0x1f<<17) | (0x7 << 25)));
