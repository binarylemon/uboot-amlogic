...
#define P_DMC_CHAN_STS            DMC_REG_BASE + (0x32 << 2)
 //bit 17       ddr1 wbuf idle.
 //bit 16       ddr0 wbuf idle.
 //bit 15:8     ambus channel idle. 
 //bit 7:0.     axibus channel idle.

#define P_DMC_N_CLK_CTRL          DMC_REG_BASE + (0x33 << 2)
  //bit 3      reserved.
  //bit 2      1: enable VPU N_CLK.
  //bit 1      1: enable DOS N_clk.
  //bit 0.     1: enable A9 CPU n_clk.
...
#define P_DMC_CMD_FILTER_CTRL5 DMC_REG_BASE + (0x44 <<2 )
  //bit 15:8.  minmum read access times to switch to write operation. 
  //bit 7:0.   minmum write access times to switch to read operation. 

#define P_DMC_CMD_BUFFER_CTRL  DMC_REG_BASE + (0x45 << 2)
