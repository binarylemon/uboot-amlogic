...
#define USB_PHY_PORT_A	    (0x100000)
#define USB_PHY_PORT_B	    (0x140000)
#define USB_PHY_PORT_C	    (0x180000)
#define USB_PHY_PORT_D	    (0x1c0000)
#define USB_PHY_PORT_MSK	(0x1f0000)
#define USB_PHY_PORT_MAX	4

#define PREI_USB_PHY_REG_A     0xc8022000
#define PREI_USB_PHY_REG_B     0xc8022020
#define PREI_USB_PHY_REG_C     0xc8022040
#define PREI_USB_PHY_REG_D     0xc8022060
 ...
 * M1/M2/M3/M6/M8/G9B are different!
 * This is only for G9B
 */ 
