...
**/
#define P_VPU_HDMI_FMT_CTRL     VPU_REG_ADDR(VPU_HDMI_FMT_CTRL)
...
#define P_DOS_MEM_PD_VDEC CBUS_REG_ADDR(DOS_MEM_PD_VDEC)
#define P_DOS_MEM_PD_VDEC2 CBUS_REG_ADDR(DOS_MEM_PD_VDEC2)
...
#define P_DOS_MEM_PD_HCODEC CBUS_REG_ADDR(DOS_MEM_PD_HCODEC)
...
#define P_HHI_HDMI_CLK_DIV CBUS_REG_ADDR(HHI_HDMI_CLK_DIV)
...
#define P_HHI_HDMI_DIVIDER_CNTL CBUS_REG_ADDR(HHI_HDMI_DIVIDER_CNTL)
...
#define P_HHI_HDMI_PLL_MOD_CNTL0 CBUS_REG_ADDR(HHI_HDMI_PLL_MOD_CNTL0)
#define P_HHI_HDMI_PLL_MOD_LOW_TCNT CBUS_REG_ADDR(HHI_HDMI_PLL_MOD_LOW_TCNT)
#define P_HHI_HDMI_PLL_MOD_HIGH_TCNT CBUS_REG_ADDR(HHI_HDMI_PLL_MOD_HIGH_TCNT)
#define P_HHI_HDMI_PLL_MOD_NOM_TCNT CBUS_REG_ADDR(HHI_HDMI_PLL_MOD_NOM_TCNT)
...
#define P_VBO_CTRL_L				VPU_REG_ADDR(VBO_CTRL_L)
#define P_VBO_CTRL_H				VPU_REG_ADDR(VBO_CTRL_H)
#define P_VBO_SOFT_RST				VPU_REG_ADDR(VBO_SOFT_RST)
#define P_VBO_LANES				VPU_REG_ADDR(VBO_LANES)
#define P_VBO_VIN_CTRL				VPU_REG_ADDR(VBO_VIN_CTRL)
#define P_VBO_ACT_VSIZE				VPU_REG_ADDR(VBO_ACT_VSIZE)
#define P_VBO_REGION_00				VPU_REG_ADDR(VBO_REGION_00)
#define P_VBO_REGION_01				VPU_REG_ADDR(VBO_REGION_01)
#define P_VBO_REGION_02				VPU_REG_ADDR(VBO_REGION_02)
#define P_VBO_REGION_03				VPU_REG_ADDR(VBO_REGION_03)
#define P_VBO_VBK_CTRL_0			VPU_REG_ADDR(VBO_VBK_CTRL_0)
#define P_VBO_VBK_CTRL_1			VPU_REG_ADDR(VBO_VBK_CTRL_1)
#define P_VBO_HBK_CTRL				VPU_REG_ADDR(VBO_HBK_CTRL)
#define P_VBO_PXL_CTRL				VPU_REG_ADDR(VBO_PXL_CTRL)
#define P_VBO_LANE_SKEW_L			VPU_REG_ADDR(VBO_LANE_SKEW_L)
#define P_VBO_LANE_SKEW_H			VPU_REG_ADDR(VBO_LANE_SKEW_H)
#define P_VBO_GCLK_LANE_L			VPU_REG_ADDR(VBO_GCLK_LANE_L)
#define P_VBO_GCLK_LANE_H			VPU_REG_ADDR(VBO_GCLK_LANE_H)
#define P_VBO_GCLK_MAIN				VPU_REG_ADDR(VBO_GCLK_MAIN)
#define P_VBO_STATUS_L				VPU_REG_ADDR(VBO_STATUS_L)
#define P_VBO_STATUS_H				VPU_REG_ADDR(VBO_STATUS_H)
#define P_VBO_LANE_OUTPUT			VPU_REG_ADDR(VBO_LANE_OUTPUT)
#define P_LCD_PORT_SWAP				VPU_REG_ADDR(LCD_PORT_SWAP)
...
#define P_VPU_VDIN_ASYNC_HOLD_CTRL VPU_REG_ADDR(VPU_VDIN_ASYNC_HOLD_CTRL)
...
#define P_HDMITX_CTRL_PORT          P_HDMI_CTRL_PORT

#define P_VPU_VLOCK_CTRL                             VPU_REG_ADDR(VPU_VLOCK_CTRL              )
#define P_VPU_VLOCK_MISC_CTRL                        VPU_REG_ADDR(VPU_VLOCK_MISC_CTRL         )
#define P_VPU_VLOCK_LOOP0_ACCUM_LMT                  VPU_REG_ADDR(VPU_VLOCK_LOOP0_ACCUM_LMT   )
#define P_VPU_VLOCK_LOOP0_CTRL0                      VPU_REG_ADDR(VPU_VLOCK_LOOP0_CTRL0       )
#define P_VPU_VLOCK_LOOP1_CTRL0                      VPU_REG_ADDR(VPU_VLOCK_LOOP1_CTRL0       )
#define P_VPU_VLOCK_LOOP1_IMISSYNC_MAX               VPU_REG_ADDR(VPU_VLOCK_LOOP1_IMISSYNC_MAX)
#define P_VPU_VLOCK_LOOP1_IMISSYNC_MIN               VPU_REG_ADDR(VPU_VLOCK_LOOP1_IMISSYNC_MIN)
#define P_VPU_VLOCK_OVWRITE_ACCUM0                   VPU_REG_ADDR(VPU_VLOCK_OVWRITE_ACCUM0    )
#define P_VPU_VLOCK_OVWRITE_ACCUM1                   VPU_REG_ADDR(VPU_VLOCK_OVWRITE_ACCUM1    )
#define P_VPU_VLOCK_OUTPUT0_CAPT_LMT                 VPU_REG_ADDR(VPU_VLOCK_OUTPUT0_CAPT_LMT  )
#define P_VPU_VLOCK_OUTPUT0_PLL_LMT                  VPU_REG_ADDR(VPU_VLOCK_OUTPUT0_PLL_LMT   )
#define P_VPU_VLOCK_OUTPUT1_CAPT_LMT                 VPU_REG_ADDR(VPU_VLOCK_OUTPUT1_CAPT_LMT  )
#define P_VPU_VLOCK_OUTPUT1_PLL_LMT                  VPU_REG_ADDR(VPU_VLOCK_OUTPUT1_PLL_LMT   )
#define P_VPU_VLOCK_LOOP1_PHSDIF_TGT                 VPU_REG_ADDR(VPU_VLOCK_LOOP1_PHSDIF_TGT  )
#define P_VPU_VLOCK_RO_LOOP0_ACCUM                   VPU_REG_ADDR(VPU_VLOCK_RO_LOOP0_ACCUM    )
#define P_VPU_VLOCK_RO_LOOP1_ACCUM                   VPU_REG_ADDR(VPU_VLOCK_RO_LOOP1_ACCUM    )
#define P_VPU_VLOCK_OROW_OCOL_MAX                    VPU_REG_ADDR(VPU_VLOCK_OROW_OCOL_MAX     )
#define P_VPU_VLOCK_RO_VS_I_DIST                     VPU_REG_ADDR(VPU_VLOCK_RO_VS_I_DIST      )
#define P_VPU_VLOCK_RO_VS_O_DIST                     VPU_REG_ADDR(VPU_VLOCK_RO_VS_O_DIST      )
#define P_VPU_VLOCK_RO_LINE_PIX_ADJ                  VPU_REG_ADDR(VPU_VLOCK_RO_LINE_PIX_ADJ   )
#define P_VPU_VLOCK_RO_OUTPUT_00_01                  VPU_REG_ADDR(VPU_VLOCK_RO_OUTPUT_00_01   )
#define P_VPU_VLOCK_RO_OUTPUT_10_11                  VPU_REG_ADDR(VPU_VLOCK_RO_OUTPUT_10_11   )
#define P_VPU_VLOCK_MX4096                           VPU_REG_ADDR(VPU_VLOCK_MX4096            )
#define P_VPU_VLOCK_STBDET_WIN0_WIN1                 VPU_REG_ADDR(VPU_VLOCK_STBDET_WIN0_WIN1  )
#define P_VPU_VLOCK_STBDET_CLP                       VPU_REG_ADDR(VPU_VLOCK_STBDET_CLP        )
#define P_VPU_VLOCK_STBDET_ABS_WIN0                  VPU_REG_ADDR(VPU_VLOCK_STBDET_ABS_WIN0   )
#define P_VPU_VLOCK_STBDET_ABS_WIN1                  VPU_REG_ADDR(VPU_VLOCK_STBDET_ABS_WIN1   )
#define P_VPU_VLOCK_STBDET_SGN_WIN0                  VPU_REG_ADDR(VPU_VLOCK_STBDET_SGN_WIN0   )
#define P_VPU_VLOCK_STBDET_SGN_WIN1                  VPU_REG_ADDR(VPU_VLOCK_STBDET_SGN_WIN1   )
#define P_VPU_VLOCK_ADJ_EN_SYNC_CTRL                 VPU_REG_ADDR(VPU_VLOCK_ADJ_EN_SYNC_CTRL  )
#define P_VPU_VLOCK_GCLK_EN                          VPU_REG_ADDR(VPU_VLOCK_GCLK_EN           )
#define P_VPU_VLOCK_LOOP1_ACCUM_LMT                  VPU_REG_ADDR(VPU_VLOCK_LOOP1_ACCUM_LMT   )
#define P_VPU_VLOCK_RO_M_INT_FRAC                    VPU_REG_ADDR(VPU_VLOCK_RO_M_INT_FRAC     )

#define P_OSDSR_HV_SIZEIN                            VPU_REG_ADDR(OSDSR_HV_SIZEIN)
#define P_OSDSR_CTRL_MODE                            VPU_REG_ADDR(OSDSR_CTRL_MODE)
#define P_OSDSR_UK_GRAD2DDIAG_LIMIT                  VPU_REG_ADDR(OSDSR_UK_GRAD2DDIAG_LIMIT)
#define P_OSDSR_UK_GRAD2DADJA_TH_RATE                VPU_REG_ADDR(OSDSR_UK_GRAD2DADJA_TH_RATE)
#define P_OSDSR_UK_GRAD2DADJA_LIMIT                  VPU_REG_ADDR(OSDSR_UK_GRAD2DADJA_LIMIT)
#define P_OSDSR_UK_BST_GAIN                          VPU_REG_ADDR(OSDSR_UK_BST_GAIN)
