#ifndef __CONFIG_M8_M101_V1_H__
#define __CONFIG_M8_M101_V1_H__

#define CONFIG_AML_MESON_8      1
#define CONFIG_MACH_MESON8_M101_V1  // generate M8 m101 machid number
...
//-----------------------------------------------------------------------
//DDR setting
#define CONFIG_DDR_CHANNEL_SET (CONFIG_DDR1_ONLY)
...
#elif !defined(CFG_DDR3_1GB) && !defined(CFG_DDR3_2GB) && !defined(CFG_DDR3_4GB) && !defined(CFG_DDR3_512MB)
	#error "Please set DDR3 capacity first in file m8_m101_v1.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file m8_m101_v1.h\n"
#endif
