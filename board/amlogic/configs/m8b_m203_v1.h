#ifndef __CONFIG_M8B_M203_V1_H__
#define __CONFIG_M8B_M203_V1_H__

#define CONFIG_MACH_MESON8_M203  // generate M8 M203 machid number
...
#define CFG_DDR_CLK    528//636 //696 //768  //792// (636)
...
//board/amlogic/m8_m203_v1/firmware/timming.c
...
#define PHYS_MEMORY_START        (0x00000000) // ???
	...
	//2Gb(X16) x 4pcs
	#define CONFIG_DDR3_ROW_SIZE (2)//(3)
	#define CONFIG_DDR3_COL_SIZE (2)
	#define CONFIG_DDR_ROW_BITS  (14)//(15)
