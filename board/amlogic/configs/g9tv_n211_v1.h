#ifndef __CONFIG_G9TV_N211_V1_H__
#define __CONFIG_G9TV_N211_V1_H__
...
#define CONFIG_IR_REMOTE_POWER_UP_KEY_CNT 2
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL1 0xEF101980//amlogic tv ir --- power
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL2 0xAF501980 //amlogic tv ir --- enter
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"try_suspend="\
        "echo try_suspend...; "\
        "if test ${reboot_mode} = charging; then "\
                "suspend; "\
		"fi;"\
        "\0"\
	"check_rebootmode="\
...
#define CONFIG_BOOTCOMMAND   "run try_suspend;run storeboot"
...
#endif //__CONFIG_G9TV_N211_V1_H__
