...
#define CONFIG_VDDAO_VOLTAGE            1000        // VDDAO voltage when boot, must have
...
#define CFG_M8_DDR_CLK    588 //696 //768  //792// (636)
...
//board/amlogic/m8_k05_NabiJR_5inch_v1/firmware/timming.c
...
//col size.   2'b01 : A0~A8,      2'b10 : A0~A9  
	...
	#error "Please set DDR3 capacity first in file m8_k05_NabiJR_5inch_v1.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file m8_k05_NabiJR_5inch_v1.h\n"
#endif
