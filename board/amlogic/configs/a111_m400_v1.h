#ifndef __CONFIG_M8B_M400_V1_H__
#define __CONFIG_M8B_M400_V1_H__

#define CONFIG_MACH_MESON8_M400  // generate M8 M400 machid number
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootupdateargs="\
	"setenv bootargs root=/dev/mmcblk0p1 rw rootfstype=vfat rootwait init=/sbin/init console=ttyS0,115200n8 no_console_suspend cvbsdrv=${cvbs_drv} vdaccfg=${vdac_config} logo=osd1,loaded,${fb_addr},${outputmode},full hdm    imode=${hdmimode} cvbsmode=${cvbsmode} hdmitx=${hdmimode} firmware=rootfs.tar.gz\0"\
       "switch_bootmode="\
