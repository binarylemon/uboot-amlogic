...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
...
#elif (CFG_M8_DDR_CLK >= 750) && (CFG_M8_DDR_CLK <= 804)
	...
	#define DDR3_9_9_9 
#elif  (CFG_M8_DDR_CLK >= 667 ) && (CFG_M8_DDR_CLK <=804)
...
//Following setting for board 7366MX-ADTV-SOCKET-V120121029 with DDR H5TQ4G63MFR (hynix)
	...
	#define CFG_M8_DDR_ZQ0CR1 0x5d
#endif

#ifdef DDR3_9_9_9
	#define CFG_M8_DDR_CL  10
	#define CFG_M8_DDR_FAW 30
	#define CFG_M8_DDR_RAS 24
	#define CFG_M8_DDR_RC  33
	#define CFG_M8_DDR_RCD 9
	#define CFG_M8_DDR_RFC 200
	#define CFG_M8_DDR_RP  9
	#define CFG_M8_DDR_RRD 5
	#define CFG_M8_DDR_WR  10
	#define CFG_M8_DDR_CWL 7
	#define CFG_M8_DDR_MOD 12
	#define CFG_M8_DDR_MRD 7
	#define CFG_M8_DDR_AL  0
	#define CFG_M8_DDR_ZQ0CR1 0x5d
	...
	#define CFG_M8_DDR_RFC 160
	#define CFG_M8_DDR_RP  7
	#define CFG_M8_DDR_RRD 6
	#define CFG_M8_DDR_WR  8
	#define CFG_M8_DDR_CWL 6
	#define CFG_M8_DDR_MOD 12
	#define CFG_M8_DDR_MRD 4
	#define CFG_M8_DDR_AL  0
	#define CFG_M8_DDR_ZQ0CR1 0x5d
...
#if defined(M8_DDR3_1GB)
	//#define DDR3_4Gbx16
	#define ddr3_row_size 3
	#define ddr3_col_size 2
#elif defined(M8_DDR3_512M)
	//#define DDR3_2Gbx16
	#define ddr3_row_size 2 
	#define ddr3_col_size 2
#else
	#error "Please define DDR3 memory capacity first in file m8_skt_v1.h!\n"
#endif
/////////////////////////////////////////////////////////////////////////////
...
static struct ddr_set __ddr_setting={
                    ...
                    .cl             =  CFG_M8_DDR_CL,
                    .t_faw          =  CFG_M8_DDR_FAW,
                    .t_ras          =  CFG_M8_DDR_RAS,
                    .t_rc           =  CFG_M8_DDR_RC,
                    .t_rcd          =  CFG_M8_DDR_RCD,
                    .t_rfc          =  CFG_M8_DDR_RFC,
                    .t_rp           =  CFG_M8_DDR_RP,
                    .t_rrd          =  CFG_M8_DDR_RRD,
                    .t_wr           =  CFG_M8_DDR_WR,
                    .t_cwl          =  CFG_M8_DDR_CWL,
                    .t_mod          =  CFG_M8_DDR_MOD,
                    .t_mrd          =  CFG_M8_DDR_MRD,
                    .t_1us_pck      =  CFG_M8_DDR_CLK,
                    .t_100ns_pck    =  CFG_M8_DDR_CLK/10,
                    .t_init_us      =  512,
                    .t_rsth_us      =  500,
                    .t_rstl_us      =  100,
                    .t_refi_100ns   =  39,
                    ...
                    .mcfg =   1 |				   //[B0] burst length: 0 for 4; 1 for 8
                           ...
                           ,
                    .zq0cr0 = 0,
                    .zq0cr1 = CFG_M8_DDR_ZQ0CR1,//0x18,   //PUB ZQ0CR1
                    .cmdzq  = 0,
         ...
         .ddr_pll_cntl= (CFG_M8_PLL_OD << 16)|(CFG_M8_PLL_N<<9)|(CFG_M8_PLL_M<<0),
         .ddr_clk= CFG_M8_DDR_CLK/2, //DDR PLL output is half of target DDR clock
...
//0x1098[0xc1104260]
	...
	#define	M8_SYS_PLL_N  (6)
	#define	M8_SYS_PLL_M  (175)
	#define M8_SYS_PLL_OD (0)
#elif (800 == CONFIG_SYS_CPU_CLK)
	#define	M8_SYS_PLL_N  (3)
	#define	M8_SYS_PLL_M  (100)	
	#define M8_SYS_PLL_OD (0)
#elif (900 == CONFIG_SYS_CPU_CLK)
	#define	M8_SYS_PLL_N  (2)
	#define	M8_SYS_PLL_M  (75)
	#define M8_SYS_PLL_OD (0)
#elif (1000 == CONFIG_SYS_CPU_CLK)
	#define	M8_SYS_PLL_N  (3)
	#define	M8_SYS_PLL_M  (125)
	#define M8_SYS_PLL_OD (0)
