...
static void uboot_show_logo(void)
{
	char *p = NULL;
...
struct amlogic_usb_config g_usb_config_g9b_skt_a={
	USB_PHY_CLK_SEL_XTAL,
	1, //PLL divider: (clock/12 -1)
	CONFIG_G9B_USBPORT_BASE_A,
	USB_ID_MODE_SW_HOST,
	NULL,//gpio_set_vbus_power, //set_vbus_power
	NULL,
};
struct amlogic_usb_config g_usb_config_g9b_skt_b={
	USB_PHY_CLK_SEL_XTAL,
	1, //PLL divider: (clock/12 -1)
	CONFIG_G9B_USBPORT_BASE_B,
	USB_ID_MODE_SW_HOST,
	NULL,//gpio_set_vbus_power, //set_vbus_power
	NULL,
};
struct amlogic_usb_config g_usb_config_g9b_skt_c={
	USB_PHY_CLK_SEL_XTAL,
	1, //PLL divider: (clock/12 -1)
	CONFIG_G9B_USBPORT_BASE_C,
	USB_ID_MODE_SW_HOST,
	NULL,//gpio_set_vbus_power, //set_vbus_power
	NULL,
};

struct amlogic_usb_config g_usb_config_g9b_skt_h={
	USB_PHY_CLK_SEL_XTAL,
	1, //PLL divider: (clock/12 -1)
	CONFIG_G9B_USBPORT_BASE_A,
...
#ifdef CONFIG_USB_DWC_OTG_HCD
	board_usb_init(&g_usb_config_g9b_skt_a,BOARD_USB_MODE_HOST);
	board_usb_init(&g_usb_config_g9b_skt_b,BOARD_USB_MODE_HOST);
	board_usb_init(&g_usb_config_g9b_skt_c,BOARD_USB_MODE_HOST);
	board_usb_init(&g_usb_config_g9b_skt_h,BOARD_USB_MODE_CHARGER);
#endif /*CONFIG_USB_DWC_OTG_HCD*/
